...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://uttermost-danthus-7ab.notion.site/4ddc9a3783764f03a3b82564761ae5d2?v=f2e776afbafa434b9f6899923955a5e7
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '4ddc9a3783764f03a3b82564761ae5d2',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'nevermore', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://nevermore-six.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'heahsele@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/heahsele', // 你的twitter个人主页
